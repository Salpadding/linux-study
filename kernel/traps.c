...
void do_general_protection(trap_stack_t stack) {
  die("general protection", (unsigned long)stack.esp, stack.error_code);
}
...
void do_debug(long esp, long error_code) { send_sig(SIGTRAP, current, 0); }
